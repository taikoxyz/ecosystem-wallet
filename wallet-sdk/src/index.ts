...
class EcosystemWallet extends Client {
    constructor(appMetadata?: AppMetadata, preview = true) {
        super({
            baseConfig: {
                ecosystemWalletDomain: preview ? 'https://wallet.taiko.io/' : 'https://wallet.sample.openfort.io/',
            ...
            appearance: {
                ...
                logo: 'https://blog-cms.openfort.io/uploads/Tko_512x512_2fd5ca74cd.png?updated_at=2025-08-26T18:50:35.460Z',
                name: 'Taiko Wallet',
                reverseDomainNameSystem: 'com.taiko.wallet'
            }
        });
